...
if (worldName == "Tanoa") then
    ...
    if (worldName == "Altis") then
        ...
        if (worldName == "Malden") then
            ...
            {
            antenas = nearestObjects [[worldSize /2,worldSize/2,0],["Land_TTowerBig_1_F","Land_TTowerBig_2_F","Land_Communication_F","Land_A_TVTower_Base","Land_Vysilac_FM","Land_Vysilac_FM2","Land_Vysilac_vez","Land_A_TVTower_base","Land_Telek1"], worldSize];
