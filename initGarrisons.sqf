...
if (gameMode == 1) then
	...
	if (worldName == "Fallujah") then
	    {
	    _mrkCSAT = ["airport","puerto","puerto_1","puesto_1","puesto_2","control_1","control_2","control_33","control_35","control_36","control_37"];
	    _controlesNATO = _controlesNATO - ["control_1","control_2","control_33","control_35","control_36","control_37"];
	    _controlesCSAT = ["control_1","control_2","control_33","control_35","control_36","control_37"];
	    }
	else
	    {
