...
switch _tipo do
	...
	case "warehouse": {_flag addAction ["Buy light vehicle", {[vehSDKLightArmed] spawn A3A_fnc_addFIAVeh},nil,0,false,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull])",4]};
