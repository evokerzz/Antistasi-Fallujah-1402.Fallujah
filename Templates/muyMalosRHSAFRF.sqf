CSATGrunt = "rhs_vdv_des_rifleman";
CSATOfficer = "rhs_vdv_des_officer";
CSATBodyG = "rhs_vmf_recon_efreitor";
CSATCrew = "rhs_vdv_des_armoredcrew";
CSATMarksman = "rhs_vdv_des_marksman";
staticCrewMuyMalos = "rhs_vdv_des_rifleman_lite";
...
vehCSATPlaneAA = "rhs_mig29sm_vvsc";
...
CSATSquad = ["rhs_vdv_des_sergeant","rhs_vdv_des_junior_sergeant","rhs_vdv_des_grenadier","rhs_vdv_des_machinegunner","rhs_vdv_des_at","rhs_vdv_des_strelok_rpg_assist","rhs_vdv_des_rifleman","rhs_vdv_des_medic"];///"O_T_InfSquad";///
CSATSpecOp = ["rhs_vmf_recon_sergeant","rhs_vmf_recon_rifleman_scout","rhs_vmf_recon_efreitor","rhs_vmf_recon_arifleman","rhs_vmf_recon_machinegunner_assistant","rhs_vdv_des_engineer","rhs_vmf_recon_rifleman_lat","rhs_vmf_recon_medic"];///(configfile >> "CfgGroups" >> "East" >> "OPF_T_F" >> "SpecOps" >> "O_T_ViperTeam");///
factionMachoMuyMalos = "rhs_faction_vmf";
gruposCSATSquad = [CSATSquad,["rhs_vdv_des_sergeant","rhs_vdv_des_junior_sergeant","rhs_vdv_des_machinegunner","rhs_vdv_des_rifleman","rhs_vdv_des_marksman","rhs_vdv_des_machinegunner_assistant","rhs_vdv_des_LAT","rhs_vdv_des_medic"],["rhs_vdv_des_sergeant","rhs_vdv_des_junior_sergeant","rhs_vdv_des_machinegunner","rhs_vdv_des_rifleman","rhs_vdv_des_marksman","rhs_vdv_des_machinegunner_assistant","rhs_vdv_des_aa","rhs_vdv_des_medic"]];//[CSATSquad,"O_T_InfSquad_Weapons"];///
